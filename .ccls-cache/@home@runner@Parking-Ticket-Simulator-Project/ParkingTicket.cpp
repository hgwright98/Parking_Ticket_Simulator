#include "ParkingTicket.h"  // Includes the header file for the ParkingTicket class
#include <iostream> 
#include <cmath>
using namespace std;
...
void ParkingTicket::displayTicket() const {
    ...
    if (overparkedMinutes > 60) {
        // This adds 10 each additional hour or part of an hour
        fine += (ceil((overparkedMinutes - 60) / 60.0) * 10);
    }

    // Display the parking ticket details to the console
    cout << "*** Parking Ticket ***\n";
